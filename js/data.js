...
const NOTIFICATIONS = [
  { id: 'n1', type: 'message', text: 'Marcus D. sent you a message', time: '2m', read: false, target: '#/dm/c1' },
  { id: 'n2', type: 'event', text: 'Weekly Gym Meetup starts in 2 hours', time: '1h', read: false, target: '#/pack/events' },
  { id: 'n3', type: 'badge', text: 'You earned the Fitness Discipline badge', time: '3h', read: false, target: '#/profile' },
  { id: 'n4', type: 'testing', text: "Reminder: time for your full blood panel STD test", time: '1d', read: true, target: '#/mind/checklist' },
  { id: 'n5', type: 'system', text: 'Chapter hike this Saturday — RSVP now', time: '2d', read: true, target: '#/pack/events' },
];
